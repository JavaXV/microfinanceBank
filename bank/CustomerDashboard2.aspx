<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerDashboard2.aspx.cs" Inherits="BankA.CustomerDashboard2" %>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="CustomerTrasact.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:Yellow;">New Transact</p>
                </a>
              </li>
               <li class="nav-item">
                ...
                <a href="File.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:Yellow;">Send Document</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="BridgeContract.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:Yellow;">Default Agreement</p>
                </a>
              </li>
               <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <a href="LoanAgreement1.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:Yellow;">Loan BoiData</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="PrintChart.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:Yellow;">Print Transaction</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
           ...
           <td  class="style3" style="left:260px; top:113px; position:absolute;  color:Black; font-size:medium"><label>
              ...
              <tr>
               ...
               <tr>
                 ...
                 &nbsp;&nbsp;
                  <tr class="style01" style="right:40px; top:27px; position:absolute;">
                  <td class="style01" style="right:40px; top:37px; position:absolute;">
   ...
   <asp:DataList ID="DataList3" runat="server">
            <ItemTemplate>
               <table>
                 <tr>
                    ...
                    <td><img src="<%#Eval("propic")%>" height="210" width="250" /></td>
                    <br /><br />
                 </tr>
            ...
            <ItemTemplate>
               <table>
                 <tr>
                    <td><img src="<%#Eval("Propic")%>" height="190" width="250" alt="IMG" /></td>
                 </tr> 
               </table>
        ...
        <tr>
         ...
         <tr>
            <td class="style15" style="color:Black; right:83px; top:525px; position:absolute; background-color:brown; font-size:small">
                <asp:FileUpload ID="FileUpload2" runat="server" />
                <br /><br />
                <asp:Button ID="Button5" runat="server" Text="Delete" 
                    onclick="Button5_Click1"  Width="85px" />
                   <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="Upload" 
                      Width="85px" />
                  <label style="color:yellow;">Signature Up</label>
                
            </td> 
          </tr>       
      
          <tr>
            <td class="style15" style="color:Black; right:80px; top:605px; position:absolute; background-color:orange; font-size:small">
                <asp:FileUpload ID="FileUpload3" runat="server" />
                <br /><br />
                <asp:Button ID="Button6" runat="server" Text="Delete" 
                    onclick="Button9_Click"  Width="85px" />
                   <asp:Button ID="Button7" runat="server" onclick="Button6_Click" Text="Upload" 
                      Width="85px" />
           ...
           <td  class="style3" style="left:260px; top:360px; position:absolute;  color:Black; font-size:medium"><label>
              ...
              <td class="style15" style="color:Black; left:500px; top:350px; position:absolute; font-size:small">
                ...
                <tr>
                 <td  class="style3" style="left:260px; top:396px; position:absolute;  color:Black; font-size:medium"><label>
               Local Govt Area:</label></td>
           
              <td class="style15" style="color:Black; left:500px; top:383px; position:absolute; font-size:small">
                <asp:TextBox ID="txtlga1" runat="server"  TextMode="Search" Width="370px" Height="32px"></asp:TextBox>
            </td> 
          </tr>               
                 <tr>
          ...
          <tr>
           <td  class="style1" style="color:Black; font-size:medium"><label>
              AccountNo:</label></td>
              <td class="style2" style="color:Black; font-size:small">
        ...
        <td class="style3" style="color:Black; position:absolute; top:800px; right:3px; font-size:small"
          <asp:TextBox ID="TextBox1" placeholder="id"
               runat="server"></asp:TextBox>

            <asp:Button ID="Button9" runat="server" Text="Pick" 
                onclick="Button9_Click1" />

            <asp:TextBox ID="txtid" runat="server" placeholder="id" Width="55px"></asp:TextBox>

            <asp:GridView ID="GridView1" runat="server" Width="206px">
