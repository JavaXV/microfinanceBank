<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedFieldOfficer.aspx.cs" Inherits="BankA.ApprovedFieldOfficer" %>
        ...
        <li class="nav-item has-treeview menu-open">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ApprovedFieldOfficer.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Field Officer Approved</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="FieldOfficer.aspx" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Officer Daily Payment</p>
                </a>
             </li>   
        </ul>
      </nav>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
         ...
         <table>
                ...
                <tr>
                 <td class="style3" style="left:260px; top:140px; position:absolute;  color:Black; font-size:large"><label>Field Officer:</label></td>
                 <td class="style2" style="color:Black;  left:500px; top:126px; position:absolute; font-size:medium"><asp:TextBox ID="txtofficers"  Height="35px" TextMode="Search" runat="server" Width="350px"></asp:TextBox></td>
             </tr>
