...
namespace BankA
{
    public partial class _777 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            {
                var styr = new AdminTable1
                {
                    UserName = txtbranch.Text,
                    PassWord = txtpassword.Text,
                    Number = 2,
                };
                db.AdminTable1s.InsertOnSubmit(styr);
                db.SubmitChanges();
        ...
        {
            //----------------------------update NewAcount---------------------------------
            var st = (from s in db.AdminTable1s where s.Number == 2 select s).First();
