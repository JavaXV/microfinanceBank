if<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountingLogin.aspx.cs" Inherits="BankA.AccountingLogin" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    <!-- Left navbar links -->
        ...
        <div class="col-sm-6">
            <h5 class="m-0 text-dark">Account-Unit</h5>
          </div><!-- /.col -->
  ...
  <a href="" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="images/IMG_8146 (2).jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
             <a href="" class="d-block">Barrister Kelechi Agnes</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
	...
	<div class="container" style="position:absolute; top:150px;">
		<div class="row">
			<div class="col-12">
				<div class="block" style="right:170px; width:700px; position:absolute;">
					<!-- Image -->
					...
					<div class="content text-center">
						...
						<form action="#">
                          <asp:TextBox ID="txtusername"  class="form-control main"  runat="server" placeholder="Enter Username"></asp:TextBox></td> 
                     
							<!-- Username -->
							
                     <asp:DropDownList ID="txtbranch" class="form-control main"  TextMode="Search"   runat="server" >
                     ...
                     <asp:ListItem>Y Lagos</asp:ListItem>
                      <asp:ListItem>Z Lagos</asp:ListItem>
                            ...
                            <asp:TextBox ID="txtpassword" class="form-control main" placeholder="Enter Password" TextMode="Password" runat="server"></asp:TextBox> 
							<!-- Submit Button -->
						
                           
                            <asp:Button ID="Button3" runat="server" class="btn btn-main-md" Text="Login" onclick="Button1_Click" />
                            <asp:Button ID="Button4" runat="server" class="btn btn-main-md" onclick="Button2_Click" Text="Sign-Up" />
                     
                   
						</form>
						<div class="new-acount">
							<p style="color:red;">By clicking “Sign Up” I agree to <a href="https://demo.themefisher.com/small-apps/privacy-policy.html">Terms of Conditions.</a></p>
