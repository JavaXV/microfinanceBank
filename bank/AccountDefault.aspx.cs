...
namespace BankA
{
    public partial class AccountDefault : System.Web.UI.Page
    {
                    ...
                    using (SqlConnection conns = new SqlConnection(constrings))
                    {
                        using (SqlCommand cmdts = new SqlCommand("SELECT id, Date FROM Tmt2 WHERE Branch = '" + DCase + "'"))
                        {
                            ...
                            using (SqlDataReader sdrr = cmdts.ExecuteReader())
                            {
                                ...
                                if (txtofficer.Text == "" || txtapproved.Text == "" || txtapproveddate.Text == "" || txtapprovedby.Text == "")
                                {
                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('All Field Are Required');", true);
                                }
                                else
                                {
                                    if (txtbranch.Text == DCase)
                                    {
                                        ...
                                        connectionu.Open();
                                        string queu = "update dbo.FieldOfficerAmount set Approved=@value1, ApproveDate=@value2, ApprovedBy=@value3  where Date='" + txtapproveddate.Text + "' AND FieldOfficer='" + txtofficer.Text + "' ";
                                    ...
                                    else if (txtbranch.Text == DCase)
                                    {
                                        ...
                                        SqlConnection connectionu = new SqlConnection(consst);
                                        connectionu.Open();
                                        string queu = "update dbo.FieldOfficerAmount set Approved=@value1, ApproveDate=@value2, ApprovedBy=@value3  where Date='" + txtdate.Text + "' AND FieldOfficer='" + txtofficer.Text + "' ";
                                        System.Data.SqlClient.SqlCommand cmd5 = new System.Data.SqlClient.SqlCommand(queu, connectionu);
                                        cmd5.Parameters.AddWithValue("@value1", value1);
                                        cmd5.Parameters.AddWithValue("@value2", value2);
                                        cmd5.Parameters.AddWithValue("@value3", value3);
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Session["USER_ID"] != null)
                {
                    ...
                    using (SqlConnection conns = new SqlConnection(constrings))
                    {
                        using (SqlCommand cmdts = new SqlCommand("SELECT id, Date FROM Tmt2 WHERE Branch = '" + txtbranch.Text + "'"))
                        {
                            cmdts.CommandType = CommandType.Text;
                            cmdts.Connection = conns;
                            conns.Open();
                            ...
                            using (SqlDataReader sdrr = cmdts.ExecuteReader())
                            {
                                ...
                                //string ValueDater = sdrr["Date"].ToString();
                                    ...
                                    //String myquery = "select * from [dbo].[FieldOfficerAmount]";
                                    string myqueryyX = "Select id, Branch, FieldOfficer, Date, CashInChat, CashInHand, Balance, AllOf, Amount from [dbo].[FieldOfficerAmount] where AllOf = '" + txtall.Text + "' and  Date = '" + txtdate.Text + "'";
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            if (txtofficer.Text == "" || txtdate.Text == "")
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('All Field Are Required');", true);
            }
            else
                        ...
                        using (SqlCommand cmdts = new SqlCommand("SELECT id, Date FROM Tmt2 WHERE Branch = '" + txtbranch.Text + "'"))
                        {
                            ...
                            using (SqlDataReader sdrr = cmdts.ExecuteReader())
                            {
                                ...
                                //string ValueDater = sdrr["Date"].ToString();
                                    ...
                                    //String myquery = "select * from [dbo].[FieldOfficerAmount]";
                                    string myqueryy = "Select id, Branch, FieldOfficer, Date, CashInChat, CashInHand, Balance, AllOf, Approved, ApproveDate, ApprovedBy, Amount from [dbo].[FieldOfficerAmount] where FieldOfficer = '" + txtofficer.Text + "' and  Date = '" + txtdate.Text + "'";
                                    ...
                                    string consyX = @"Data Source=DESKTOP-URMGVCS\SQLEXPRESS;Initial Catalog=PrudentBankSQL;Integrated Security=True";
                                    //String myquery = "select * from [dbo].[FieldOfficerAmount]";
                                    string myqueryyX = "Select id, Branch, FieldOfficer, Date, CashInChat, CashInHand, Balance, AllOf, Amount from [dbo].[FieldOfficer] where FieldOfficer = '" + txtofficer.Text + "' and  Date = '" + txtdate.Text + "'";
                                    ...
                                    var result3W = dtyX.AsEnumerable()
                                           .Sum(x => Convert.ToInt32(x["Amount"]));

                                    Lab4.Text = "Amount" + " :" + result3W.ToString("#,##0.00");
                                    ...
                                    //String myquery = "select * from [dbo].[FieldOfficerAmount]";
                                    string myqueryyXW = "Select id, Branch, FieldOfficer, Date, CashInChat, CashInHand, Balance, AllOf, Amount from [dbo].[FieldOfficerAmount] where FieldOfficer = '" + txtofficer.Text + "' and  Date = '" + txtdate.Text + "'";
                                    ...
                                    var result3yWW = dtyXW.AsEnumerable()
                                              .Sum(x => Convert.ToInt32(x["Amount"]));

                                    Lab4.Text = "Amount" + " :" + result3yWW.ToString("#,##0.00");
